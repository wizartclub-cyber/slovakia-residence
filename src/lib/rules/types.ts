...
export type RouteMatch = {
  ...
  /**
   * Обов'язкові умови, які саме ваші відповіді підтвердили. Що їх більше, то
   * конкретніше маршрут відповідає сказаному — це міра точності збігу,
   * а не оцінка шансів.
   */
  ...
  /**
   * true, якщо результат був би `eligible`, але умови маршруту внесені не
   * повністю. Інтерфейс мусить це пояснити: «умови ще не перевірені юристом».
   */
  cappedByIncompleteConditions: boolean;
