...
# Уточнення від 2026-09-09: бланк 11-057 має новішу версію

Пошук показав, що чинна офіційна версія бланка — **11-057 IV-2025**, і публікує її
**minv.sk**, а не mzv.sk. Стара адреса на minv.sk більше не працює: сайт міністерства
перебудували.

Коли зберігатимеш шість файлів MZV із браузера, спробуй спершу знайти бланки на
minv.sk через пошук по сайту («tlačivá», «žiadosť o udelenie prechodného pobytu»).
Якщо знайдеш версію IV-2025 — зберігай саме її, вона новіша за ту, на яку зараз
показує наш реєстр. Назви файлів лишаються ті самі (`mzv-form-11-057.pdf` тощо),
а різницю у версії я потім запишу в реєстр.
